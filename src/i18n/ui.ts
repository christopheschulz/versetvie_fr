...
export const ui = {
  fr: {
    ...
    'faq.a4': 'Nous utilisons principalement la Bible Louis Segond, l\'une des traductions françaises les plus répandues et appréciées.',
  ...
  en: {
    ...
    'faq.a4': 'We use the World English Bible (WEB), a modern and accessible translation in the public domain.',
  ...
  de: {
    ...
    'faq.a4': 'Wir verwenden die Schlachter 1951, eine geschätzte und weit verbreitete deutsche Bibelübersetzung.',
